...
public class Terminal extends Composite implements ITerminal {
	private int terminalHandle;

	private int scrolledHandle;
	...
	public Terminal(Composite parent, int style) {
		...
		terminals.put(new Integer(terminalHandle), this);
	...
	protected void widgetDisposed(DisposeEvent e) {
		terminals.remove(new Integer(terminalHandle));
		terminalHandle = 0;
	}
	...
	protected Point computeNativeSize (int /*long*/ h, int wHint, int hHint, boolean changed) {
