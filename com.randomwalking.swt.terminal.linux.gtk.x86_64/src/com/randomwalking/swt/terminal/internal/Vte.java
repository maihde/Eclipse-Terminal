...
public class Vte {
	 ...
	 */
	private final static native long _vte_terminal_new();
	public final static long vte_terminal_new() {
		Platform.lock.lock();
		try {
	 ...
	 */
	private final static native void _vte_terminal_feed(long handle, String data);
	public final static void vte_terminal_feed(long handle, String data) {
		Platform.lock.lock();
		try {
	 ...
	 */
	private final static native void _vte_terminal_feed_child(long handle, byte[] data);
	public final static void vte_terminal_feed_child(long handle, byte[] data) {
		Platform.lock.lock();
		try {
	 ...
	 */
	private final static native void _vte_terminal_set_color_foreground(long handle, GdkColor color);
	public final static void vte_terminal_set_color_foreground(long handle, GdkColor color) {
		Platform.lock.lock();
		try {
	 ...
	 */
	private final static native void _vte_terminal_set_color_background(long handle, GdkColor color);
	public final static void vte_terminal_set_color_background(long handle, GdkColor color) {
		Platform.lock.lock();
		try {
	 ...
	 */
	private final static native void _vte_terminal_reset(long handle, boolean clear_tabstops, boolean clear_history);
	public final static void vte_terminal_reset(long handle, boolean clear_tabstops, boolean clear_history) {
		Platform.lock.lock();
		try {
	 ...
	 */
	private final static native void _vte_terminal_set_scrollback_lines(long handle, int lines);
	public final static void vte_terminal_set_scrollback_lines(long handle, int lines) {
		Platform.lock.lock();
		try {
